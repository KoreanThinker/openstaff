...
const StaffMetricsTab = lazy(() =>
  import('@/pages/staff-detail/tabs/StaffMetricsTab').then((m) => ({ default: m.StaffMetricsTab }))
)
const StaffKpiTab = lazy(() =>
  import('@/pages/staff-detail/tabs/StaffKpiTab').then((m) => ({ default: m.StaffKpiTab }))
)
const StaffMemoryTab = lazy(() =>
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange}>
        ...
        <TabsContent value="metrics" className="mt-4">
          <Suspense fallback={<Skeleton className="h-64 w-full" />}>
            <StaffMetricsTab staffId={staffId} />
          </Suspense>
        </TabsContent>
        ...
        <TabsContent value="kpi" className="mt-4">
          <Suspense fallback={<Skeleton className="h-64 w-full" />}>
            <StaffKpiTab staffId={staffId} />
          </Suspense>
        </TabsContent>

        <TabsContent value="memory" className="mt-4">
          <Suspense fallback={<Skeleton className="h-64 w-full" />}>
            <StaffMemoryTab staffId={staffId} />
          </Suspense>
        </TabsContent>
