...
export const api = {
  ...
  pauseStaff: (id: string) => request<{ status: string }>(`/api/staffs/${id}/pause`, { method: 'POST' }),
  resumeStaff: (id: string) => request<{ status: string }>(`/api/staffs/${id}/resume`, { method: 'POST' }),
