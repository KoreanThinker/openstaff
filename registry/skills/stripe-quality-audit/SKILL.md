---
name: stripe-quality-audit
description: Stripe quality audit skill for autonomous execution cycles.
allowed-tools: Read Write Bash
compatibility: Requires STRIPE_API_KEY.
metadata:
  author: openstaff
  version: 1.0.0
---

# Stripe Quality Audit
