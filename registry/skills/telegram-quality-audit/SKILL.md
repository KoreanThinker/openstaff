---
name: telegram-quality-audit
description: Telegram quality audit skill for autonomous execution cycles.
allowed-tools: Read Write Bash
compatibility: Requires TELEGRAM_BOT_TOKEN.
metadata:
  author: openstaff
  version: 1.0.0
---

# Telegram Quality Audit

Use this skill to run reliable quality audit cycles inside OpenStaff.
