---
name: gitlab-quality-audit
description: GitLab quality audit skill for autonomous execution cycles.
allowed-tools: Read Write Bash
compatibility: Requires GITLAB_TOKEN.
metadata:
  author: openstaff
  version: 1.0.0
---

# Gitlab Quality Audit
